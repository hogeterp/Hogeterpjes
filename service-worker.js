const CACHE="hogeterpjes-v1.3.10-kluis";
const ASSETS=["./","./index.html","./style.css?v=1.3.10","./app.js?v=1.3.10","./firebase-config.js?v=1.3.10","./manifest.json?v=1.3.10","./logo.jpg","./icon-192.png","./icon-512.png"];
