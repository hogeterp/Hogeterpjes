const CACHE="hogeterpjes-v1.3.5-meeters-meldingen";
const ASSETS=["./","./index.html","./style.css?v=1.3.5","./app.js?v=1.3.5","./firebase-config.js?v=1.3.5","./manifest.json?v=1.3.5","./logo.jpg","./icon-192.png","./icon-512.png"];
