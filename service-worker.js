const CACHE="hogeterpjes-v1.3.21-security-gifts-agenda";
const ASSETS=["./","./index.html","./style.css?v=1.3.21","./app.js?v=1.3.21","./firebase-config.js?v=1.3.21","./manifest.json?v=1.3.21","./logo.jpg","./icon-192.png","./icon-512.png"];
