const CACHE="hogeterpjes-v1.2.8";
const ASSETS=["./","./index.html","./style.css?v=1.2.8","./app.js?v=1.2.8","./firebase-config.js?v=1.2.8","./manifest.json?v=1.2.8","./logo.jpg","./icon-192.png","./icon-512.png"];
