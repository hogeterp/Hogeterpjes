const CACHE="hogeterpjes-v1.2.5";
const ASSETS=["./","./index.html","./style.css?v=1.2.5","./app.js?v=1.2.5","./firebase-config.js?v=1.2.5","./manifest.json?v=1.2.5","./logo.jpg","./icon-192.png","./icon-512.png"];
