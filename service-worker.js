const CACHE="hogeterpjes-v1.2.9";
const ASSETS=["./","./index.html","./style.css?v=1.2.9","./app.js?v=1.2.9","./firebase-config.js?v=1.2.9","./manifest.json?v=1.2.9","./logo.jpg","./icon-192.png","./icon-512.png"];
