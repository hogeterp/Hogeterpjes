const CACHE="hogeterpjes-v1.3.3-meeters-meldingen";
const ASSETS=["./","./index.html","./style.css?v=1.3.3","./app.js?v=1.3.3","./firebase-config.js?v=1.3.3","./manifest.json?v=1.3.3","./logo.jpg","./icon-192.png","./icon-512.png"];
