const CACHE="hogeterpjes-v1.3.4-meeters-meldingen";
const ASSETS=["./","./index.html","./style.css?v=1.3.4","./app.js?v=1.3.4","./firebase-config.js?v=1.3.4","./manifest.json?v=1.3.4","./logo.jpg","./icon-192.png","./icon-512.png"];
