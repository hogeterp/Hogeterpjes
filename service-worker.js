const CACHE="hogeterpjes-v1.3.26-cadeau-ideeen-gegroepeerd";
const ASSETS=["./","./index.html","./style.css?v=1.3.26","./app.js?v=1.3.26","./firebase-config.js?v=1.3.26","./manifest.json?v=1.3.26","./logo.jpg","./icon-192.png","./icon-512.png"];
