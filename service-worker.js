const CACHE="hogeterpjes-v1.2.2";
const ASSETS=["./","./index.html","./style.css?v=1.2.2","./app.js?v=1.2.2","./firebase-config.js?v=1.2.2","./manifest.json?v=1.2.2","./logo.jpg","./icon-192.png","./icon-512.png"];
