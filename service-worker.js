const CACHE="hogeterpjes-v1.3.33-priority-fix";
const ASSETS=["./","./index.html","./style.css?v=1.3.33","./app.js?v=1.3.33","./firebase-config.js?v=1.3.33","./manifest.json?v=1.3.33","./logo.jpg","./icon-192.png","./icon-512.png"];
