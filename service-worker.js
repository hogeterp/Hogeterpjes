const CACHE="hogeterpjes-v1.3.18-rinze-dagboek-fix";
const ASSETS=["./","./index.html","./style.css?v=1.3.18","./app.js?v=1.3.18","./firebase-config.js?v=1.3.18","./manifest.json?v=1.3.18","./logo.jpg","./icon-192.png","./icon-512.png"];
