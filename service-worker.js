const CACHE="hogeterpjes-v1.3.0";
const ASSETS=["./","./index.html","./style.css?v=1.3.0","./app.js?v=1.3.0","./firebase-config.js?v=1.3.0","./manifest.json?v=1.3.0","./logo.jpg","./icon-192.png","./icon-512.png"];
