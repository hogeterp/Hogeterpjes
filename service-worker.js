const CACHE="hogeterpjes-v1.2.7";
const ASSETS=["./","./index.html","./style.css?v=1.2.7","./app.js?v=1.2.7","./firebase-config.js?v=1.2.7","./manifest.json?v=1.2.7","./logo.jpg","./icon-192.png","./icon-512.png"];
