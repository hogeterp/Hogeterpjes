const CACHE="hogeterpjes-v1.3.31-agenda-todos";
const ASSETS=["./","./index.html","./style.css?v=1.3.31","./app.js?v=1.3.31","./firebase-config.js?v=1.3.31","./manifest.json?v=1.3.31","./logo.jpg","./icon-192.png","./icon-512.png"];
