const CACHE="hogeterpjes-v1.3.30-agenda-todos";
const ASSETS=["./","./index.html","./style.css?v=1.3.30","./app.js?v=1.3.30","./firebase-config.js?v=1.3.30","./manifest.json?v=1.3.30","./logo.jpg","./icon-192.png","./icon-512.png"];
