const CACHE="hogeterpjes-v1.3.32-agenda-todos";
const ASSETS=["./","./index.html","./style.css?v=1.3.32","./app.js?v=1.3.32","./firebase-config.js?v=1.3.32","./manifest.json?v=1.3.32","./logo.jpg","./icon-192.png","./icon-512.png"];
