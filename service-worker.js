const CACHE="hogeterpjes-v1.3.17-cadeaus-vrijdagweek-agenda";
const ASSETS=["./","./index.html","./style.css?v=1.3.17","./app.js?v=1.3.17","./firebase-config.js?v=1.3.17","./manifest.json?v=1.3.17","./logo.jpg","./icon-192.png","./icon-512.png"];
