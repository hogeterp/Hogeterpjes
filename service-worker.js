const CACHE="hogeterpjes-v1.3.12-kluis";
const ASSETS=["./","./index.html","./style.css?v=1.3.12","./app.js?v=1.3.12","./firebase-config.js?v=1.3.12","./manifest.json?v=1.3.12","./logo.jpg","./icon-192.png","./icon-512.png"];
