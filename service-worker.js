const CACHE="hogeterpjes-v1.3.23-prive-cadeau-ideeen";
const ASSETS=["./","./index.html","./style.css?v=1.3.23","./app.js?v=1.3.23","./firebase-config.js?v=1.3.23","./manifest.json?v=1.3.23","./logo.jpg","./icon-192.png","./icon-512.png"];
