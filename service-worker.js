const CACHE="hogeterpjes-v1.3.8-kluis";
const ASSETS=["./","./index.html","./style.css?v=1.3.8","./app.js?v=1.3.8","./firebase-config.js?v=1.3.8","./manifest.json?v=1.3.8","./logo.jpg","./icon-192.png","./icon-512.png"];
