const CACHE="hogeterpjes-v1.3.20-home-agenda-photo";
const ASSETS=["./","./index.html","./style.css?v=1.3.20","./app.js?v=1.3.20","./firebase-config.js?v=1.3.20","./manifest.json?v=1.3.20","./logo.jpg","./icon-192.png","./icon-512.png"];
