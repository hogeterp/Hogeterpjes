const CACHE="hogeterpjes-v1.3.22-duidelijke-cadeauteksten";
const ASSETS=["./","./index.html","./style.css?v=1.3.22","./app.js?v=1.3.22","./firebase-config.js?v=1.3.22","./manifest.json?v=1.3.22","./logo.jpg","./icon-192.png","./icon-512.png"];
