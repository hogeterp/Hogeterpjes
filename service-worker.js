const CACHE="hogeterpjes-v1.3.25-cadeau-ideeen-gegroepeerd";
const ASSETS=["./","./index.html","./style.css?v=1.3.25","./app.js?v=1.3.25","./firebase-config.js?v=1.3.25","./manifest.json?v=1.3.25","./logo.jpg","./icon-192.png","./icon-512.png"];
