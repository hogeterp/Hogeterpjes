const CACHE="hogeterpjes-v1.3.19-agenda-boodschappen";
const ASSETS=["./","./index.html","./style.css?v=1.3.19","./app.js?v=1.3.19","./firebase-config.js?v=1.3.19","./manifest.json?v=1.3.19","./logo.jpg","./icon-192.png","./icon-512.png"];
