const CACHE="hogeterpjes-v1.2.4";
const ASSETS=["./","./index.html","./style.css?v=1.2.4","./app.js?v=1.2.4","./firebase-config.js?v=1.2.4","./manifest.json?v=1.2.4","./logo.jpg","./icon-192.png","./icon-512.png"];
