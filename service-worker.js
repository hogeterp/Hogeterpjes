const CACHE="hogeterpjes-v1.3.34-todo-photo";
const ASSETS=["./","./index.html","./style.css?v=1.3.34","./app.js?v=1.3.34","./firebase-config.js?v=1.3.34","./manifest.json?v=1.3.34","./logo.jpg","./icon-192.png","./icon-512.png"];
