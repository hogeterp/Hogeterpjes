const CACHE="hogeterpjes-v1.3.16-dagboek-fotos-agenda";
const ASSETS=["./","./index.html","./style.css?v=1.3.16","./app.js?v=1.3.16","./firebase-config.js?v=1.3.16","./manifest.json?v=1.3.16","./logo.jpg","./icon-192.png","./icon-512.png"];
