const CACHE="hogeterpjes-v1.3.28-agenda-todos";
const ASSETS=["./","./index.html","./style.css?v=1.3.28","./app.js?v=1.3.28","./firebase-config.js?v=1.3.28","./manifest.json?v=1.3.28","./logo.jpg","./icon-192.png","./icon-512.png"];
