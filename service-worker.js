const CACHE="hogeterpjes-v1.3.27-cadeau-ideeen-gegroepeerd";
const ASSETS=["./","./index.html","./style.css?v=1.3.27","./app.js?v=1.3.27","./firebase-config.js?v=1.3.27","./manifest.json?v=1.3.27","./logo.jpg","./icon-192.png","./icon-512.png"];
