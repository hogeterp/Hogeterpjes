const CACHE="hogeterpjes-v1.3.29-agenda-todos";
const ASSETS=["./","./index.html","./style.css?v=1.3.29","./app.js?v=1.3.29","./firebase-config.js?v=1.3.29","./manifest.json?v=1.3.29","./logo.jpg","./icon-192.png","./icon-512.png"];
