const CACHE="hogeterpjes-v1.3.9-kluis";
const ASSETS=["./","./index.html","./style.css?v=1.3.9","./app.js?v=1.3.9","./firebase-config.js?v=1.3.9","./manifest.json?v=1.3.9","./logo.jpg","./icon-192.png","./icon-512.png"];
