const CACHE="hogeterpjes-v1.3.11-kluis";
const ASSETS=["./","./index.html","./style.css?v=1.3.11","./app.js?v=1.3.11","./firebase-config.js?v=1.3.11","./manifest.json?v=1.3.11","./logo.jpg","./icon-192.png","./icon-512.png"];
