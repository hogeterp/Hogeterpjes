const CACHE="hogeterpjes-v1.2.3";
const ASSETS=["./","./index.html","./style.css?v=1.2.3","./app.js?v=1.2.3","./firebase-config.js?v=1.2.3","./manifest.json?v=1.2.3","./logo.jpg","./icon-192.png","./icon-512.png"];
