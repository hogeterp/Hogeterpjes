...
- Bestaande ingebedde foto's worden na het openen van v1.3.37 automatisch naar Firebase Storage verplaatst en daarna uit het grote Firestore-document gehaald.
- Hierdoor blijft het gedeelde Firestore-document klein en wordt de Firestore-documentlimiet niet meer geraakt door foto's.
- De Firebase-opslagmeter en Dagjes uit uit v1.3.37 blijven behouden.

## Firebase
Voor v1.3.37 is **storage.rules gewijzigd**. Firestore-regels zijn niet gewijzigd.
...
4. Controleer bovenaan dat **v1.3.37** staat.
